 ...
 */
  ...
  * 响应数据:
  * {code:200,msg:'upload succ',fileName:'1234567891-1353.jpg'}
  * 
  */
...
// 定义路由,使用文件上传中间件
 router.post('/image',upload.single('dishImg'),(req,res)=>{
  ...
  fs.rename(tmpFile, 'img/dish/'+newFile, ()=>{
    res.send({code:200, msg: 'upload succ',fileName:newFile})  //把零食文件转移
    });
  })

  /**
   * 生成一个随机的文件名
   * @param {*} suffix 表示要生产的文件中的后缀
   */
